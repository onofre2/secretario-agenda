...
const PROFILE_BLOCKS: Record<NoteProfile, {
  ...
  default: {
    abertura: [
      (name: string) => `${name} chegou ao consultório no horário combinado.`,
      (name: string) => `Deu-se início ao cuidado de ${name} nesta data.`,
      (name: string) => `${name} esteve presente, dando seguimento ao acompanhamento.`,
      (name: string) => `Recebido(a) ${name} para mais uma etapa do processo terapêutico.`,
      (name: string) => `${name} retornou para dar continuidade aos cuidados propostos.`,
      (name: string) => `Teve início o encontro terapêutico com ${name}.`,
      (name: string) => `${name} manteve o compromisso agendado, comparecendo normalmente.`,
      (name: string) => `Aberta a sessão com ${name}, seguindo a programação prevista.`,
    ],
    b2: [
      "Verificou-se como o paciente vem respondendo ao longo do processo.",
      "Colheram-se informações sobre o momento atual apresentado.",
      "Notou-se a forma como os sintomas se comportaram recentemente.",
      "Buscou-se entender as demandas mais relevantes no momento.",
      "Revisaram-se pontos observados na visita anterior.",
      "Investigou-se brevemente o quadro antes de iniciar as atividades.",
      "Percebeu-se a evolução do caso desde o último encontro.",
      "Analisou-se o contexto clínico para orientar a proposta do dia.",
    ],
    b3: [
      "Foram propostas atividades voltadas à necessidade identificada.",
      "Desenvolveram-se práticas alinhadas ao objetivo traçado.",
      "Utilizaram-se recursos compatíveis com a demanda apresentada.",
      "Conduziu-se o encontro com foco nas metas estabelecidas.",
      "Exploraram-se estratégias adequadas ao momento do paciente.",
      "Empregaram-se métodos direcionados à proposta terapêutica.",
      "Colocaram-se em prática as ações planejadas para esta fase.",
      "Guiou-se o trabalho pelas necessidades específicas do caso.",
    ],
    b4: [
      "A continuidade dos cuidados segue conforme previsto.",
      "Novos encontros já estão programados para dar sequência.",
      "O processo caminha dentro do esperado até o momento.",
      "As próximas etapas serão ajustadas conforme necessário.",
      "Há expectativa de manter o ritmo atual de acompanhamento.",
      "O caso será reavaliado periodicamente ao longo do tratamento.",
      "Segue-se acompanhando de perto a resposta apresentada.",
      "A trajetória do cuidado permanece estável neste período.",
    ],
  },
  neuro: {
    abertura: [
